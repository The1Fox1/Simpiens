...
namespace Simpiens.Entities
{
    ...
    public class NodeFactory
    {
        ...
        [Inject]
        public NodeFactory(IObjectResolver resolver, IWorldRegistry worldRegistry)
        {
            _resolver = resolver;
        ...
        public void CreateNode(Vector2 position, NodeConfiguration? config = null)
        {
            ...
            GUID nodeId = GUID.Generate();
            controller.Initialize(nodeId, configuration);

            _worldRegistry.RegisterNode(controller);
        }
    }
}
